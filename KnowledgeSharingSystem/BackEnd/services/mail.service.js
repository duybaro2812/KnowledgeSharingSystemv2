...
const sendAdditionalEmailOtpEmail = async ({ toEmail, otpCode, expiresMinutes = 10 }) => {
    const transporter = buildTransporter();
    ...
    await transporter.sendMail({
        from,
        to: toEmail,
        subject: 'Your OTP for recovery email verification',
        text: `Your recovery email verification OTP is ${otpCode}. It expires in ${expiresMinutes} minutes.`,
        html: `
            <div style="font-family: Segoe UI, Arial, sans-serif; padding: 16px;">
